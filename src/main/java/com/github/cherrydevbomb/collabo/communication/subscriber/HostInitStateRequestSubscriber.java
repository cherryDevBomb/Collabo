...
public class HostInitStateRequestSubscriber implements RedisPubSubListener<String, String> {
    ...
    public HostInitStateRequestSubscriber(String initStateTransferChannel) {
    ...
    public void message(String channel, String message) {
        ...
        // TODO form init state message
        RedisPubSubAsyncCommands<String, String> async = redisConnection.async();
        try {
            long subscriberCount = async.publish(initStateTransferChannel, "Initial state message").get();
